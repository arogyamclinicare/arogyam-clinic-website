...
export function ConsultationBooking({ isOpen, onClose, treatmentType = 'General Consultation' }: ConsultationBookingProps) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-2 sm:p-4 bg-black/70 backdrop-blur-xl">
      <div className="card-premium rounded-2xl sm:rounded-3xl max-w-3xl w-full max-h-[98vh] sm:max-h-[95vh] overflow-hidden shadow-2xl animate-scale-in border-0 relative flex flex-col">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-3 lg:space-y-4">
            <div className="space-y-2 sm:space-y-3 lg:space-y-4 flex-1">
              <div className="flex items-center justify-between space-x-2 sm:space-x-3 lg:space-x-4">
                   ...
                   <div className="w-8 h-8 sm:w-10 sm:h-10 lg:w-14 lg:h-14 bg-gradient-to-br from-blue-500 to-cyan-600 rounded-lg sm:rounded-xl lg:rounded-2xl flex items-center justify-center animate-glow flex-shrink-0">
                     <Calendar className="w-4 h-4 sm:w-5 sm:h-5 lg:w-7 lg:h-7 text-white" />
                   </div>
                   <div className="flex-1 min-w-0">
                     <h2 className="text-base sm:text-lg lg:text-2xl xl:text-3xl font-display font-bold text-white leading-tight">
                       {currentStep === 'booking' ? (
                         <span>
                           <span className="block sm:inline">Book Your</span>
